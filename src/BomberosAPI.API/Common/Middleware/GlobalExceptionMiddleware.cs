...
/// <summary>
/// Middleware que intercepta todas las excepciones no controladas y devuelve
/// respuestas HTTP consistentes sin exponer detalles internos sensibles.
/// </summary>
public class GlobalExceptionMiddleware
{
    ...
    private ApiResponse<object?> HandleUnexpected(HttpContext context, Exception ex)
    {
        ...
        // En produccion no se exponen detalles internos
